...
function startAudio(incoming){
    document.getElementById("videoHolder").playbackRate = 1;
    document.getElementById("videoHolder").currentTime = incoming['currentTime'];
...
function evalStringAsFunction(incoming){
    ...
    document.getElementById("videoHolder").currentTime = window.elapsed;
...
function setCaptions(thisCaption){
