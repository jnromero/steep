...
function loadClickSound(){
    var clickSound = document.createElement('video');
    clickSound.id = 'clickHolder';
    clickSound.src = window.config['packageFolder']+'/javascript/simulateMouse/mouseClick.mp3';
    clickSound.preload='auto'
    document.getElementById("mainDiv").appendChild(clickSound);
}


function playClickSound(){
    document.getElementById("clickHolder").play();    
}
